...
void _personSerialize(
  ...
  writer.writeString(offsets[4], object.relation);
...
Person _personDeserialize(
  ...
  object.relation = reader.readStringOrNull(offsets[4]);
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'relation',
      ));
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'relation',
      ));
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'relation',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> relationIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'relation',
        value: '',
...
extension PersonQuerySortBy on QueryBuilder<Person, Person, QSortBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByRelation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relation', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByRelationDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQuerySortThenBy on QueryBuilder<Person, Person, QSortThenBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByRelation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relation', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByRelationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relation', Sort.desc);
    });
  }
...
extension PersonQueryWhereDistinct on QueryBuilder<Person, Person, QDistinct> {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByRelation(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, String?, QQueryOperations> relationProperty() {
    return QueryBuilder.apply(this, (query) {
